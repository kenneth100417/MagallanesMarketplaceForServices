                ...
                <div class="card" >
                    <div class="card-body mt-5 mb-5" >
                        <div class="d-flex flex-column align-items-center text-center">
                            ...
                            <form action="{{url('change_cu_profile_pic')}}" id="change-profile-pic-form" method="POST" enctype="multipart/form-data">
                                @csrf
    ...
    <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{url('/edit_cu_profile')}}" method="POST" id="profile-update-form">
                    @csrf
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="d-flex justify-content-center">
                                    <input name="address" type="text float-end"  class="form-control" style="width: 400px !important" value="{{$user->address}}" required>
                                    @error('address')
                                        <p class="text-danger">{{$message}}</p>
                                    @enderror
                                </div>
    ...
    <div class="modal fade" id="changePassword" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{url('/cu_change_password')}}" method="POST" id="change-password-form">
                    @csrf
                    <div class="modal-body">
                        <div class="container-fluid">
                            <div class="row mt-3">
